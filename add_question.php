...
<body>
							    ...
							    <form class="form-horizontal" method="post">
										...
										<div class="control-group">
											...
											<div class="controls">			
													...
													<div id="opt14">
														Answer: <input type="text" name="ans5" size="60"> <input name="answer" value="E" type="radio"><br><br>
													</div>
											</div>
										</div>
	...
	<script>
	jQuery("#opt14 input[type='text']").on('input', function() {
        var inputValue = jQuery(this).val();
        jQuery("#opt14 input[name='ans5']").val(inputValue);
        jQuery("#opt14 input[name='answer']").val(inputValue); // Set radio button value dynamically
      });
	</script>				
		...
		if ($type  == '2'){
   		...
   		mysqli_query($conn, "insert into quiz_question (quiz_id,question_text,date_added,answer,question_type_id) 
    		...
    		or die(mysqli_error());
		mysqli_query($conn,"insert into answer (quiz_question_id,answer_text,choices) values('$quiz_question_id','$ans5','D')")or die(mysqli_error());
