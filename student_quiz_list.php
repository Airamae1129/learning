...
<th>Gold</th> <!-- Title for quizGold column -->
            <th>Experience</th> <!-- Title for quizExp column -->
												<th></th>
												</tr>
										</thead>
										<tbody>
 ...
 $quiz_gold = $row['quizGold']; // Retrieve quizGold value
    $quiz_exp = $row['quizExp']; // Retrieve quizExp value
...
<td><?php echo $quiz_gold; ?></td> <!-- Display quizGold value -->
        <td><?php echo $quiz_exp; ?></td> <!-- Display quizExp value -->                                
                                         <td width="200">
										<?php if ($grade == ""){ ?>
