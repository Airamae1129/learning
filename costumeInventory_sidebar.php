...
<li class=""><a href="profile.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Profile</a></li>
			 <li class=""><a href="characterCustomization.php"><i class="icon-chevron-right"></i><i class="icon-star"></i>&nbsp;Character Customization</a></li>
<li class="active"><a href="costumeInventory.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Costume Inventory</a></li>
