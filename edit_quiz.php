                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="inputExp">Quiz Experience</label>
                                        <div class="controls">
                                            <input type="text" value="<?php echo $row['quizExp']; ?>" class="span8" name="exp" id="inputExp" placeholder="Quiz Experience">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="inputGold">Quiz Gold</label>
                                        <div class="controls">
                                            <input type="text" value="<?php echo $row['quizGold']; ?>" class="span8" name="gold" id="inputGold" placeholder="Quiz Gold">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <div class="controls">
                                ...
                                if (isset($_POST['save'])){
                                    ...
                                    mysqli_query($conn, "UPDATE quiz SET 
                                        quiz_title = '$quiz_title',
                                        quiz_description = '$description',
                                        quizExp = '$exp',
                                        quizGold = '$gold'
                                        WHERE quiz_id = '$quiz_id'") or die(mysqli_error());
                                    ?>
                                    <script>
