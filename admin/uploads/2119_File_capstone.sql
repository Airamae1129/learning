...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2024 at 05:46 PM
...
(19, 'Start of classes', 0, '01/04/2024', '01/04/2024');
...
(14, 'fee', '23f2', '2024-04-02 18:10:51', 20, 500, 600);
...
(220, 'Kyle', 'Halili', 22, '69696969', 'password', 'uploads/kylebridge.jpg', 'Registered', '', 209, 345, 'http://localhost/lms/admin/uploads/hat1.png', 'http://localhost/lms/admin/uploads/shirt1.png', 'http://localhost/lms/admin/uploads/pants1.png', 'http://localhost/lms/admin/uploads/hand1.png'),
...
(227, 'johnny', 'test', 0, '68686868', '', 'uploads/NO-IMAGE-AVAILABLE.jpg', 'Unregistered', 'testlang@gmail.com', 2, 0, 'uploads/hat1.png', '', '', '');
...
(94, 'admin', '2024-02-27 18:16:50', '', 15),
(95, 'admin', '2024-02-27 18:24:48', '', 15),
(96, 'admin', '2024-02-28 17:41:05', '', 15),
(97, 'admin', '2024-02-28 17:42:53', '', 15),
(98, 'admin', '2024-02-28 17:50:44', '', 15),
(99, 'admin', '2024-04-01 17:32:29', '', 15);
...
--
ALTER TABLE `quiz_question`
  MODIFY `quiz_question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `student_class_quiz`
  MODIFY `student_class_quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `teacher_class_student`
  MODIFY `teacher_class_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=392;
