                            ...
                            <div class="span12">
                                ...
                                <form action="delete_teacher.php" method="post">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        <a data-toggle="modal" href="#teacher_delete" id="delete" class="btn btn-danger" name="">Delete User <i class="icon-trash icon-large"></i></a>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($teacher_query)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30">
                                                        <a href="edit_teacher.php<?php echo '?id=' . $id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
                                                    </td>
                                                    <td width="40">
                                                        ...
                                                        <div id="delete_user_modal_<?php echo htmlspecialchars($id); ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel_<?php echo htmlspecialchars($id); ?>" aria-hidden="true">
                                                            <div class="modal-header">
                                                                ...
                                                                <h3 id="myModalLabel_<?php echo htmlspecialchars($id); ?>">Delete Teacher</h3>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p>Are you sure you want to delete the teacher <?php echo htmlspecialchars($row['firstname']) . ' ' . htmlspecialchars($row['lastname']); ?>?</p>
                                                            </div>
